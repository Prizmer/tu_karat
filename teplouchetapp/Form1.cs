...
namespace elfextendedapp
{
    public partial class Form1 : Form
    {
        ...
        #region Строковые постоянные 
            ...
            const string FORM_TEXT_DEFAULT = "Карат 30X Modbus - группа v.0.1";
...
";
        ...
        private void btnIndPollInfo_Click(object sender, EventArgs e)
        {
            ...
            string versionMeter = "-1";
            if (!pd.getMeterModel(ref versionMeter))
            {
        ...
        {
            textBoxIp.Text = "192.168.23.32";
            textBoxPort.Text = "3002";
        }
    }
